...
async def _handle_ws_and_ask_confirmation(update: Update, context: CallbackContext, payload_ws: dict):
    try:
...
payment_conversation = ConversationHandler(
    ...
    states={
        ...
        CONFIRM:  [CallbackQueryHandler(execute_callback, pattern=r"^(confirm_ws|cancel_ws):")],
    },
    fallbacks=[]
)
